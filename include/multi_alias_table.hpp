...
class multi_alias_table {
    ...
    public: 
        ...
        void balance_weight() { 
            ...
            std::map<table_id_type, std::vector<item>> local_table_items;
            ...
            using ygm_items_map_ptr = ygm::ygm_ptr<std::map<table_id_type, std::vector<item>>>;
    ...
    private:
        ...
        RNG                                                 m_rng;
        std::map<table_id_type, std::vector<item>>          m_local_items;
        std::map<table_id_type, std::vector<table_item>>    m_local_alias_tables;
